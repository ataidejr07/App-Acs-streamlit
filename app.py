...
st.set_page_config(page_title="Meu App", page_icon="🏠", layout="wide") st.title("Meu App")  # Nome do aplicativo st.write("Bem-vindo, Ataide!")

Sidebar para opções secundárias

with st.sidebar: st.header("Outras Opções") st.button("Cartões Espelho", help="Visualizar Cartões Espelho", key="cartoes_espelho") st.button("Laudos e Receitas", help="Gerenciar Laudos e Receitas", key="laudos_receitas")
